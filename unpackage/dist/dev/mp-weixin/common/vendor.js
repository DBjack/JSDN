...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"FW-MUSIC","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var md5 = __webpack_require__(/*! @/GraceUI5/js/md5.js */ 40);
module.exports = {
  // 版本检查
